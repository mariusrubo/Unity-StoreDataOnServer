...
# Setup
The project consists of 1. a php script that you will need store on your server 2. a C# script that sends data to that php script from within a Unity application. The php script then writes the data onto a file located in the same folder. 
